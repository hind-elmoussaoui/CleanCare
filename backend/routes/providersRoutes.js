...
const Provider = require("../models/ProviderModels.js");
...
// Mettre à jour le profil complet du prestataire
router.put('/profile', upload.single('photo'), async (req, res) => {
  try {
      ...
      const decoded = jwt.verify(token, "votreSecretKey");
      const { phone, address, bio, experience, cin, services } = req.body;
...
// Récupérer un prestataire spécifique (pour admin)
