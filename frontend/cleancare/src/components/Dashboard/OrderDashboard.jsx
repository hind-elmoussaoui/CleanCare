    ...
    try {
      ...
      if (!response.ok) {
        if (response.status === 404) {
          throw new Error(
            "Commande introuvable - elle a peut-être déjà été supprimée"
          );
        }
        throw new Error(`Erreur HTTP : ${response.status}`);
      }
    ...
    return (
        <div className="flex min-h-screen">
            ...
            <div className="flex-1 p-6">
                <h2 className="text-2xl font-bold mb-2">Tableau de bord des commandes</h2>
          ...
          >
            ...
            <div>
              <p className="font-semibold">
                {notification.isSuccess ? "Succès" : "Erreur"}
              </p>
          ...
          <div className="fixed inset-0 bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white rounded-lg p-6 max-w-md w-full border border-red-600">
              ...
              <p className="mb-4">
                ...
                <strong>
                  {orderToDelete?.firstName} {orderToDelete?.lastName}
                </strong>{" "}
                ?
                <br />
