...
const MoreInfo = () => {
  ...
  return (
    <div className="bg-gray-50">
      {/* Hero Section */}
      <section className="relative py-20 px-6 text-white" data-aos="fade">
        ...
        >
          ...
          <p className="text-xl max-w-3xl mx-auto text-[#6b345c]">
            Découvrez pourquoi des centaines de familles nous font confiance
            pour l'entretien de leur maison et la garde de leurs enfants.
          </p>
        </div>
      </section>
      ...
      <section className="py-10 px-6 bg-gray-100">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div data-aos="fade-right">
              <div className="mb-8">
                ...
                <p className="text-gray-600">
                  Nous recrutons uniquement les meilleurs professionnels et leur
                  offrons une formation continue pour garantir des services de
              ...
              <div className="mb-8">
                ...
                <p className="text-gray-600">
                  Tous nos intervenants passent des vérifications d'antécédents
                  approfondies et sont suivis régulièrement pour votre
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Nous nous adaptons à vos besoins spécifiques, que ce soit pour
                  un service ponctuel ou régulier, en journée ou en soirée.
                </p>
              </div>
            </div>
            ...
            >
              <h3 className="text-2xl font-semibold mb-6 text-center text-[#7098da]">
                Nos Chiffres Clés
              </h3>
              <div
              ...
              >
                {stats.map((stat, index) => (
                  <div
                    ...
                    data-aos-delay={300 + index * 100}
                  >
                    <p className="text-4xl font-bold text-[#d15cb1]">
                      {stat.value}
                    </p>
        ...
        >
          <div className="px-4 mx-auto">
            ...
            <Link to="/contact">
              <button className="px-8 py-3 bg-white text-[#d15cb1] font-semibold rounded-lg shadow-md hover:bg-[#d15cb1] hover:text-white transition duration-300 hover:scale-105 active:scale-95">
                Nous Contacter
              </button>
            </Link>
          </div>
