...
const steps = ["Service", "Planning", "Coordonnées", "Confirmation"];

const servicesData = [
  { id: 1, name: "Ménage à domicile", description: "Nettoyage complet de votre maison.", price: "150", icon: "🧹" },
  { id: 2, name: "Garde d'enfants", description: "Nounou qualifiée pour vos enfants.", price: "200", icon: "👶" },
  { id: 3, name: "Ménage de bureaux", description: "Entretien de votre espace de travail.", price: "250", icon: "🏢" },
  { id: 4, name: "Garde de nuit", description: "Assistance nocturne pour vos enfants.", price: "300", icon: "🌙" },
  { id: 5, name: "Ménage en profondeur", description: "Nettoyage après départ/arrivée.", price: "350", icon: "✨" },
  { id: 6, name: "Baby-sitting week-end", description: "Garde d'enfants le week-end.", price: "180", icon: "🏖️" },
];
...
export default function BookingForm() {
  ...
  }, [frequency, selectedDate, startDate, endDate, selectedDays, selectedService]);
        ...
        >
          ...
          {step === 0 && (
            <div className="p-6 sm:p-8">
              <h2 className="text-2xl font-bold text-gray-800 mb-6">Choisissez votre service</h2>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {servicesData.map((service) => (
                  <button
                    key={service.id}
                    onClick={() => setSelectedService(service)}
                    className={`p-4 rounded-lg border-2 transition-all duration-200 flex items-start ${
                  ...
                  >
                    ...
                    <div className="text-left">
                      ...
                      <p className="text-pink-600 font-medium mt-2">{service.price} MAD</p>
                    </div>
                  </button>
                ))}
              </div>
              ...
              <div className="bg-gray-50 rounded-lg p-6 text-left mb-8">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                  ...
                  <div>
                    ...
                    <p className="font-medium">{selectedService.price} MAD</p>
                  </div>
                </div>
